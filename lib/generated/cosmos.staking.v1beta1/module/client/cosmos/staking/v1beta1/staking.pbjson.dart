...
final $typed_data.Uint8List commissionRatesDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List commissionDescriptor = $convert.base64Decode('CgpDb21taXNzaW9uElwKEGNvbW1pc3Npb25fcmF0ZXMYASABKAsyJy5jb3Ntb3Muc3Rha2luZy52MWJldGExLkNvbW1pc3Npb25SYXRlc0II0N4fAcjeHwBSD2NvbW1pc3Npb25SYXRlcxJFCgt1cGRhdGVfdGltZRgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBCCMjeHwCQ3x8BUgp1cGRhdGVUaW1lOgjooB8BmKAfAA==');
...
final $typed_data.Uint8List descriptionDescriptor = $convert.base64Decode('CgtEZXNjcmlwdGlvbhIYCgdtb25pa2VyGAEgASgJUgdtb25pa2VyEhoKCGlkZW50aXR5GAIgASgJUghpZGVudGl0eRIYCgd3ZWJzaXRlGAMgASgJUgd3ZWJzaXRlEikKEHNlY3VyaXR5X2NvbnRhY3QYBCABKAlSD3NlY3VyaXR5Q29udGFjdBIYCgdkZXRhaWxzGAUgASgJUgdkZXRhaWxzOgjooB8BmKAfAA==');
...
const Validator$json = const {
  ...
  '2': const [
    ...
    const {'1': 'unbonding_height', '3': 8, '4': 1, '5': 3, '10': 'unbondingHeight'},
...
final $typed_data.Uint8List validatorDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use valAddressesDescriptor instead')
const ValAddresses$json = const {
  '1': 'ValAddresses',
  '2': const [
    const {'1': 'addresses', '3': 1, '4': 3, '5': 9, '8': const {}, '10': 'addresses'},
  ],
  '7': const {},
};

/// Descriptor for `ValAddresses`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List valAddressesDescriptor = $convert.base64Decode('CgxWYWxBZGRyZXNzZXMSNgoJYWRkcmVzc2VzGAEgAygJQhjStC0UY29zbW9zLkFkZHJlc3NTdHJpbmdSCWFkZHJlc3NlczoImKAfAIDcIAE=');
...
final $typed_data.Uint8List dVPairDescriptor = $convert.base64Decode('CgZEVlBhaXISRQoRZGVsZWdhdG9yX2FkZHJlc3MYASABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1IQZGVsZWdhdG9yQWRkcmVzcxJFChF2YWxpZGF0b3JfYWRkcmVzcxgCIAEoCUIY0rQtFGNvc21vcy5BZGRyZXNzU3RyaW5nUhB2YWxpZGF0b3JBZGRyZXNzOgzooB8AiKAfAJigHwA=');
...
final $typed_data.Uint8List dVVTripletDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List delegationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List unbondingDelegationDescriptor = $convert.base64Decode('');
...
const UnbondingDelegationEntry$json = const {
  ...
  '2': const [
    const {'1': 'creation_height', '3': 1, '4': 1, '5': 3, '10': 'creationHeight'},
...
final $typed_data.Uint8List unbondingDelegationEntryDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List redelegationEntryDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List redelegationDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use paramsDescriptor instead')
const Params$json = const {
  '1': 'Params',
  '2': const [
    const {'1': 'unbonding_time', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '8': const {}, '10': 'unbondingTime'},
    const {'1': 'max_validators', '3': 2, '4': 1, '5': 13, '10': 'maxValidators'},
    const {'1': 'max_entries', '3': 3, '4': 1, '5': 13, '10': 'maxEntries'},
    const {'1': 'historical_entries', '3': 4, '4': 1, '5': 13, '10': 'historicalEntries'},
...
final $typed_data.Uint8List paramsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List redelegationEntryResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List poolDescriptor = $convert.base64Decode('');
