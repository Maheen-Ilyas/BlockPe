...
final $typed_data.Uint8List queryValidatorRequestDescriptor = $convert.base64Decode('ChVRdWVyeVZhbGlkYXRvclJlcXVlc3QSPwoOdmFsaWRhdG9yX2FkZHIYASABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1INdmFsaWRhdG9yQWRkcg==');
...
final $typed_data.Uint8List queryValidatorDelegationsRequestDescriptor = $convert.base64Decode('CiBRdWVyeVZhbGlkYXRvckRlbGVnYXRpb25zUmVxdWVzdBI/Cg52YWxpZGF0b3JfYWRkchgBIAEoCUIY0rQtFGNvc21vcy5BZGRyZXNzU3RyaW5nUg12YWxpZGF0b3JBZGRyEkYKCnBhZ2luYXRpb24YAiABKAsyJi5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXF1ZXN0UgpwYWdpbmF0aW9u');
...
final $typed_data.Uint8List queryValidatorUnbondingDelegationsRequestDescriptor = $convert.base64Decode('CilRdWVyeVZhbGlkYXRvclVuYm9uZGluZ0RlbGVnYXRpb25zUmVxdWVzdBI/Cg52YWxpZGF0b3JfYWRkchgBIAEoCUIY0rQtFGNvc21vcy5BZGRyZXNzU3RyaW5nUg12YWxpZGF0b3JBZGRyEkYKCnBhZ2luYXRpb24YAiABKAsyJi5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXF1ZXN0UgpwYWdpbmF0aW9u');
...
const QueryDelegationRequest$json = const {
  ...
  '2': const [
    const {'1': 'delegator_addr', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'delegatorAddr'},
    const {'1': 'validator_addr', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'validatorAddr'},
  ],
  '7': const {},
};

/// Descriptor for `QueryDelegationRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryDelegationRequestDescriptor = $convert.base64Decode('ChZRdWVyeURlbGVnYXRpb25SZXF1ZXN0Ej8KDmRlbGVnYXRvcl9hZGRyGAEgASgJQhjStC0UY29zbW9zLkFkZHJlc3NTdHJpbmdSDWRlbGVnYXRvckFkZHISPwoOdmFsaWRhdG9yX2FkZHIYAiABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1INdmFsaWRhdG9yQWRkcjoI6KAfAIigHwA=');
...
final $typed_data.Uint8List queryUnbondingDelegationRequestDescriptor = $convert.base64Decode('Ch9RdWVyeVVuYm9uZGluZ0RlbGVnYXRpb25SZXF1ZXN0Ej8KDmRlbGVnYXRvcl9hZGRyGAEgASgJQhjStC0UY29zbW9zLkFkZHJlc3NTdHJpbmdSDWRlbGVnYXRvckFkZHISPwoOdmFsaWRhdG9yX2FkZHIYAiABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1INdmFsaWRhdG9yQWRkcjoI6KAfAIigHwA=');
...
final $typed_data.Uint8List queryDelegatorDelegationsRequestDescriptor = $convert.base64Decode('CiBRdWVyeURlbGVnYXRvckRlbGVnYXRpb25zUmVxdWVzdBI/Cg5kZWxlZ2F0b3JfYWRkchgBIAEoCUIY0rQtFGNvc21vcy5BZGRyZXNzU3RyaW5nUg1kZWxlZ2F0b3JBZGRyEkYKCnBhZ2luYXRpb24YAiABKAsyJi5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXF1ZXN0UgpwYWdpbmF0aW9uOgjooB8AiKAfAA==');
...
final $typed_data.Uint8List queryDelegatorUnbondingDelegationsRequestDescriptor = $convert.base64Decode('CilRdWVyeURlbGVnYXRvclVuYm9uZGluZ0RlbGVnYXRpb25zUmVxdWVzdBI/Cg5kZWxlZ2F0b3JfYWRkchgBIAEoCUIY0rQtFGNvc21vcy5BZGRyZXNzU3RyaW5nUg1kZWxlZ2F0b3JBZGRyEkYKCnBhZ2luYXRpb24YAiABKAsyJi5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXF1ZXN0UgpwYWdpbmF0aW9uOgjooB8AiKAfAA==');
...
const QueryRedelegationsRequest$json = const {
  ...
  '2': const [
    const {'1': 'delegator_addr', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'delegatorAddr'},
    const {'1': 'src_validator_addr', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'srcValidatorAddr'},
    const {'1': 'dst_validator_addr', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'dstValidatorAddr'},
...
final $typed_data.Uint8List queryRedelegationsRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List queryDelegatorValidatorsRequestDescriptor = $convert.base64Decode('Ch9RdWVyeURlbGVnYXRvclZhbGlkYXRvcnNSZXF1ZXN0Ej8KDmRlbGVnYXRvcl9hZGRyGAEgASgJQhjStC0UY29zbW9zLkFkZHJlc3NTdHJpbmdSDWRlbGVnYXRvckFkZHISRgoKcGFnaW5hdGlvbhgCIAEoCzImLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlcXVlc3RSCnBhZ2luYXRpb246COigHwCIoB8A');
...
final $typed_data.Uint8List queryDelegatorValidatorRequestDescriptor = $convert.base64Decode('Ch5RdWVyeURlbGVnYXRvclZhbGlkYXRvclJlcXVlc3QSPwoOZGVsZWdhdG9yX2FkZHIYASABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1INZGVsZWdhdG9yQWRkchI/Cg52YWxpZGF0b3JfYWRkchgCIAEoCUIY0rQtFGNvc21vcy5BZGRyZXNzU3RyaW5nUg12YWxpZGF0b3JBZGRyOgjooB8AiKAfAA==');
