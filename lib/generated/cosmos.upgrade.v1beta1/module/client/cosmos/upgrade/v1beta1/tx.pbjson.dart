...
const MsgSoftwareUpgrade$json = const {
  ...
  '2': const [
    ...
    const {'1': 'plan', '3': 2, '4': 1, '5': 11, '6': '.cosmos.upgrade.v1beta1.Plan', '8': const {}, '10': 'plan'},
  ],
  '7': const {},
};

/// Descriptor for `MsgSoftwareUpgrade`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List msgSoftwareUpgradeDescriptor = $convert.base64Decode('ChJNc2dTb2Z0d2FyZVVwZ3JhZGUSNgoJYXV0aG9yaXR5GAEgASgJQhjStC0UY29zbW9zLkFkZHJlc3NTdHJpbmdSCWF1dGhvcml0eRI2CgRwbGFuGAIgASgLMhwuY29zbW9zLnVwZ3JhZGUudjFiZXRhMS5QbGFuQgTI3h8AUgRwbGFuOg6C57AqCWF1dGhvcml0eQ==');
...
final $typed_data.Uint8List msgSoftwareUpgradeResponseDescriptor = $convert.base64Decode('ChpNc2dTb2Z0d2FyZVVwZ3JhZGVSZXNwb25zZQ==');
...
final $typed_data.Uint8List msgCancelUpgradeDescriptor = $convert.base64Decode('ChBNc2dDYW5jZWxVcGdyYWRlEjYKCWF1dGhvcml0eRgBIAEoCUIY0rQtFGNvc21vcy5BZGRyZXNzU3RyaW5nUglhdXRob3JpdHk6DoLnsCoJYXV0aG9yaXR5');
...
final $typed_data.Uint8List msgCancelUpgradeResponseDescriptor = $convert.base64Decode('ChhNc2dDYW5jZWxVcGdyYWRlUmVzcG9uc2U=');
