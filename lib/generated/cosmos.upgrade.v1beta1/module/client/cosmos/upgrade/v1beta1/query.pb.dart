...
class QueryCurrentPlanResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryCurrentPlanResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.upgrade.v1beta1'), createEmptyInstance: create)
    ..aOM<$5.Plan>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'plan', subBuilder: $5.Plan.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $5.Plan get plan => $_getN(0);
  @$pb.TagNumber(1)
  set plan($5.Plan v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPlan() => $_has(0);
  @$pb.TagNumber(1)
  void clearPlan() => clearField(1);
  @$pb.TagNumber(1)
  $5.Plan ensurePlan() => $_ensure(0);
}
...
class QueryModuleVersionsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryModuleVersionsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.upgrade.v1beta1'), createEmptyInstance: create)
    ..pc<$5.ModuleVersion>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'moduleVersions', $pb.PbFieldType.PM, subBuilder: $5.ModuleVersion.create)
    ..hasRequiredFields = false
  ;

  QueryModuleVersionsResponse._() : super();
  factory QueryModuleVersionsResponse({
    $core.Iterable<$5.ModuleVersion>? moduleVersions,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $core.List<$5.ModuleVersion> get moduleVersions => $_getList(0);
}

class QueryAuthorityRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryAuthorityRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.upgrade.v1beta1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryAuthorityRequest copyWith(void Function(QueryAuthorityRequest) updates) => super.copyWith((message) => updates(message as QueryAuthorityRequest)) as QueryAuthorityRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class QueryAuthorityResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryAuthorityResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.upgrade.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryAuthorityResponse copyWith(void Function(QueryAuthorityResponse) updates) => super.copyWith((message) => updates(message as QueryAuthorityResponse)) as QueryAuthorityResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
