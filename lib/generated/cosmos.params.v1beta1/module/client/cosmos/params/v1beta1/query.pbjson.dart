...
final $typed_data.Uint8List querySubspacesRequestDescriptor = $convert.base64Decode('ChVRdWVyeVN1YnNwYWNlc1JlcXVlc3Q=');
...
const QuerySubspacesResponse$json = const {
  ...
  '2': const [
    const {'1': 'subspaces', '3': 1, '4': 3, '5': 11, '6': '.cosmos.params.v1beta1.Subspace', '10': 'subspaces'},
  ],
};

/// Descriptor for `QuerySubspacesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List querySubspacesResponseDescriptor = $convert.base64Decode('ChZRdWVyeVN1YnNwYWNlc1Jlc3BvbnNlEj0KCXN1YnNwYWNlcxgBIAMoCzIfLmNvc21vcy5wYXJhbXMudjFiZXRhMS5TdWJzcGFjZVIJc3Vic3BhY2Vz');
...
final $typed_data.Uint8List subspaceDescriptor = $convert.base64Decode('CghTdWJzcGFjZRIaCghzdWJzcGFjZRgBIAEoCVIIc3Vic3BhY2USEgoEa2V5cxgCIAMoCVIEa2V5cw==');
