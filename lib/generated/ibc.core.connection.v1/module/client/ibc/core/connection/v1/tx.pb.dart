...
class MsgConnectionOpenInit extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  MsgConnectionOpenInit copyWith(void Function(MsgConnectionOpenInit) updates) => super.copyWith((message) => updates(message as MsgConnectionOpenInit)) as MsgConnectionOpenInit; // ignore: deprecated_member_use
...
class MsgConnectionOpenInitResponse extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MsgConnectionOpenInitResponse copyWith(void Function(MsgConnectionOpenInitResponse) updates) => super.copyWith((message) => updates(message as MsgConnectionOpenInitResponse)) as MsgConnectionOpenInitResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MsgConnectionOpenTry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgConnectionOpenTry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.connection.v1'), createEmptyInstance: create)
    ...
    ..aOM<$9.Height>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight', subBuilder: $9.Height.create)
    ...
    ..aOM<$9.Height>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusHeight', subBuilder: $9.Height.create)
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $4.Counterparty? counterparty,
    $fixnum.Int64? delayPeriod,
    $core.Iterable<$4.Version>? counterpartyVersions,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MsgConnectionOpenTry copyWith(void Function(MsgConnectionOpenTry) updates) => super.copyWith((message) => updates(message as MsgConnectionOpenTry)) as MsgConnectionOpenTry; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  $9.Height get proofHeight => $_getN(6);
  @$pb.TagNumber(7)
  set proofHeight($9.Height v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasProofHeight() => $_has(6);
  @$pb.TagNumber(7)
  void clearProofHeight() => clearField(7);
  @$pb.TagNumber(7)
  $9.Height ensureProofHeight() => $_ensure(6);
  ...
  @$pb.TagNumber(11)
  $9.Height get consensusHeight => $_getN(10);
  @$pb.TagNumber(11)
  set consensusHeight($9.Height v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasConsensusHeight() => $_has(10);
  @$pb.TagNumber(11)
  void clearConsensusHeight() => clearField(11);
  @$pb.TagNumber(11)
  $9.Height ensureConsensusHeight() => $_ensure(10);
...
class MsgConnectionOpenTryResponse extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MsgConnectionOpenTryResponse copyWith(void Function(MsgConnectionOpenTryResponse) updates) => super.copyWith((message) => updates(message as MsgConnectionOpenTryResponse)) as MsgConnectionOpenTryResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MsgConnectionOpenAck extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgConnectionOpenAck', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.connection.v1'), createEmptyInstance: create)
    ...
    ..aOM<$9.Height>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight', subBuilder: $9.Height.create)
    ...
    ..aOM<$9.Height>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusHeight', subBuilder: $9.Height.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MsgConnectionOpenAck copyWith(void Function(MsgConnectionOpenAck) updates) => super.copyWith((message) => updates(message as MsgConnectionOpenAck)) as MsgConnectionOpenAck; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  $9.Height get proofHeight => $_getN(4);
  @$pb.TagNumber(5)
  set proofHeight($9.Height v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasProofHeight() => $_has(4);
  @$pb.TagNumber(5)
  void clearProofHeight() => clearField(5);
  @$pb.TagNumber(5)
  $9.Height ensureProofHeight() => $_ensure(4);
  ...
  @$pb.TagNumber(9)
  $9.Height get consensusHeight => $_getN(8);
  @$pb.TagNumber(9)
  set consensusHeight($9.Height v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasConsensusHeight() => $_has(8);
  @$pb.TagNumber(9)
  void clearConsensusHeight() => clearField(9);
  @$pb.TagNumber(9)
  $9.Height ensureConsensusHeight() => $_ensure(8);
...
class MsgConnectionOpenAckResponse extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MsgConnectionOpenAckResponse copyWith(void Function(MsgConnectionOpenAckResponse) updates) => super.copyWith((message) => updates(message as MsgConnectionOpenAckResponse)) as MsgConnectionOpenAckResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MsgConnectionOpenConfirm extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MsgConnectionOpenConfirm copyWith(void Function(MsgConnectionOpenConfirm) updates) => super.copyWith((message) => updates(message as MsgConnectionOpenConfirm)) as MsgConnectionOpenConfirm; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MsgConnectionOpenConfirmResponse extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MsgConnectionOpenConfirmResponse copyWith(void Function(MsgConnectionOpenConfirmResponse) updates) => super.copyWith((message) => updates(message as MsgConnectionOpenConfirmResponse)) as MsgConnectionOpenConfirmResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
