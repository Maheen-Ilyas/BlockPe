...
class ConnectionEnd extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  ConnectionEnd copyWith(void Function(ConnectionEnd) updates) => super.copyWith((message) => updates(message as ConnectionEnd)) as ConnectionEnd; // ignore: deprecated_member_use
...
class IdentifiedConnection extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IdentifiedConnection copyWith(void Function(IdentifiedConnection) updates) => super.copyWith((message) => updates(message as IdentifiedConnection)) as IdentifiedConnection; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ClientPaths extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClientPaths copyWith(void Function(ClientPaths) updates) => super.copyWith((message) => updates(message as ClientPaths)) as ClientPaths; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConnectionPaths extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConnectionPaths copyWith(void Function(ConnectionPaths) updates) => super.copyWith((message) => updates(message as ConnectionPaths)) as ConnectionPaths; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
