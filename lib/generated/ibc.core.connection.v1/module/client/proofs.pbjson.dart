...
const HashOp$json = const {
  ...
  '2': const [
    ...
    const {'1': 'BITCOIN', '2': 5},
    const {'1': 'SHA512_256', '2': 6},
  ],
};

/// Descriptor for `HashOp`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List hashOpDescriptor = $convert.base64Decode('CgZIYXNoT3ASCwoHTk9fSEFTSBAAEgoKBlNIQTI1NhABEgoKBlNIQTUxMhACEgoKBktFQ0NBSxADEg0KCVJJUEVNRDE2MBAEEgsKB0JJVENPSU4QBRIOCgpTSEE1MTJfMjU2EAY=');
