...
const Block$json = const {
  '1': 'Block',
  '2': const [
    const {'1': 'header', '3': 1, '4': 1, '5': 11, '6': '.cosmos.base.tendermint.v1beta1.Header', '8': const {}, '10': 'header'},
...
final $typed_data.Uint8List blockDescriptor = $convert.base64Decode('');
...
const Header$json = const {
  ...
  '2': const [
    ...
    const {'1': 'proposer_address', '3': 14, '4': 1, '5': 9, '10': 'proposerAddress'},
  ],
};
