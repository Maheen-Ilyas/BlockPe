...
class DuplicateVoteEvidence extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DuplicateVoteEvidence', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.types'), createEmptyInstance: create)
    ..aOM<$7.Vote>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'voteA', subBuilder: $7.Vote.create)
    ..aOM<$7.Vote>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'voteB', subBuilder: $7.Vote.create)
  ...
  @$pb.TagNumber(1)
  $7.Vote get voteA => $_getN(0);
  @$pb.TagNumber(1)
  set voteA($7.Vote v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasVoteA() => $_has(0);
  @$pb.TagNumber(1)
  void clearVoteA() => clearField(1);
  @$pb.TagNumber(1)
  $7.Vote ensureVoteA() => $_ensure(0);

  @$pb.TagNumber(2)
  $7.Vote get voteB => $_getN(1);
  @$pb.TagNumber(2)
  set voteB($7.Vote v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasVoteB() => $_has(1);
  @$pb.TagNumber(2)
  void clearVoteB() => clearField(2);
  @$pb.TagNumber(2)
  $7.Vote ensureVoteB() => $_ensure(1);
...
class LightClientAttackEvidence extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LightClientAttackEvidence', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.types'), createEmptyInstance: create)
    ..aOM<$7.LightBlock>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conflictingBlock', subBuilder: $7.LightBlock.create)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commonHeight')
    ..pc<$6.Validator>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'byzantineValidators', $pb.PbFieldType.PM, subBuilder: $6.Validator.create)
  ...
  factory LightClientAttackEvidence({
    $7.LightBlock? conflictingBlock,
    $fixnum.Int64? commonHeight,
    $core.Iterable<$6.Validator>? byzantineValidators,
    $fixnum.Int64? totalVotingPower,
    $5.Timestamp? timestamp,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $7.LightBlock get conflictingBlock => $_getN(0);
  @$pb.TagNumber(1)
  set conflictingBlock($7.LightBlock v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasConflictingBlock() => $_has(0);
  @$pb.TagNumber(1)
  void clearConflictingBlock() => clearField(1);
  @$pb.TagNumber(1)
  $7.LightBlock ensureConflictingBlock() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $core.List<$6.Validator> get byzantineValidators => $_getList(2);
