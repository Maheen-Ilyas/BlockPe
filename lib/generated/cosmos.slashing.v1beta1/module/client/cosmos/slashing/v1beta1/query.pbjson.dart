...
const QuerySigningInfoRequest$json = const {
  ...
  '2': const [
    const {'1': 'cons_address', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'consAddress'},
  ],
};

/// Descriptor for `QuerySigningInfoRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List querySigningInfoRequestDescriptor = $convert.base64Decode('ChdRdWVyeVNpZ25pbmdJbmZvUmVxdWVzdBI7Cgxjb25zX2FkZHJlc3MYASABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1ILY29uc0FkZHJlc3M=');
