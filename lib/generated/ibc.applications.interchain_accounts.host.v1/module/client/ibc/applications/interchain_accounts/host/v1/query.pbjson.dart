...
const QueryParamsResponse$json = const {
  ...
  '2': const [
    const {'1': 'params', '3': 1, '4': 1, '5': 11, '6': '.ibc.applications.interchain_accounts.host.v1.Params', '10': 'params'},
  ],
};

/// Descriptor for `QueryParamsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryParamsResponseDescriptor = $convert.base64Decode('ChNRdWVyeVBhcmFtc1Jlc3BvbnNlEkwKBnBhcmFtcxgBIAEoCzI0LmliYy5hcHBsaWNhdGlvbnMuaW50ZXJjaGFpbl9hY2NvdW50cy5ob3N0LnYxLlBhcmFtc1IGcGFyYW1z');
