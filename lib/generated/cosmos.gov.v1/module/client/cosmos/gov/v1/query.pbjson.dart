...
const QueryProposalResponse$json = const {
  ...
  '2': const [
    const {'1': 'proposal', '3': 1, '4': 1, '5': 11, '6': '.cosmos.gov.v1.Proposal', '10': 'proposal'},
  ],
};

/// Descriptor for `QueryProposalResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryProposalResponseDescriptor = $convert.base64Decode('ChVRdWVyeVByb3Bvc2FsUmVzcG9uc2USMwoIcHJvcG9zYWwYASABKAsyFy5jb3Ntb3MuZ292LnYxLlByb3Bvc2FsUghwcm9wb3NhbA==');
@$core.Deprecated('Use queryProposalsRequestDescriptor instead')
const QueryProposalsRequest$json = const {
  '1': 'QueryProposalsRequest',
  '2': const [
    const {'1': 'proposal_status', '3': 1, '4': 1, '5': 14, '6': '.cosmos.gov.v1.ProposalStatus', '10': 'proposalStatus'},
    const {'1': 'voter', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'voter'},
    const {'1': 'depositor', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'depositor'},
...
final $typed_data.Uint8List queryProposalsRequestDescriptor = $convert.base64Decode('');
...
const QueryProposalsResponse$json = const {
  ...
  '2': const [
    const {'1': 'proposals', '3': 1, '4': 3, '5': 11, '6': '.cosmos.gov.v1.Proposal', '10': 'proposals'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryProposalsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryProposalsResponseDescriptor = $convert.base64Decode('ChZRdWVyeVByb3Bvc2Fsc1Jlc3BvbnNlEjUKCXByb3Bvc2FscxgBIAMoCzIXLmNvc21vcy5nb3YudjEuUHJvcG9zYWxSCXByb3Bvc2FscxJHCgpwYWdpbmF0aW9uGAIgASgLMicuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVzcG9uc2VSCnBhZ2luYXRpb24=');
...
final $typed_data.Uint8List queryVoteRequestDescriptor = $convert.base64Decode('ChBRdWVyeVZvdGVSZXF1ZXN0Eh8KC3Byb3Bvc2FsX2lkGAEgASgEUgpwcm9wb3NhbElkEi4KBXZvdGVyGAIgASgJQhjStC0UY29zbW9zLkFkZHJlc3NTdHJpbmdSBXZvdGVy');
@$core.Deprecated('Use queryVoteResponseDescriptor instead')
const QueryVoteResponse$json = const {
  '1': 'QueryVoteResponse',
  '2': const [
    const {'1': 'vote', '3': 1, '4': 1, '5': 11, '6': '.cosmos.gov.v1.Vote', '10': 'vote'},
  ],
};

/// Descriptor for `QueryVoteResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryVoteResponseDescriptor = $convert.base64Decode('ChFRdWVyeVZvdGVSZXNwb25zZRInCgR2b3RlGAEgASgLMhMuY29zbW9zLmdvdi52MS5Wb3RlUgR2b3Rl');
...
const QueryVotesResponse$json = const {
  ...
  '2': const [
    const {'1': 'votes', '3': 1, '4': 3, '5': 11, '6': '.cosmos.gov.v1.Vote', '10': 'votes'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryVotesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryVotesResponseDescriptor = $convert.base64Decode('ChJRdWVyeVZvdGVzUmVzcG9uc2USKQoFdm90ZXMYASADKAsyEy5jb3Ntb3MuZ292LnYxLlZvdGVSBXZvdGVzEkcKCnBhZ2luYXRpb24YAiABKAsyJy5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXNwb25zZVIKcGFnaW5hdGlvbg==');
...
const QueryParamsResponse$json = const {
  ...
  '2': const [
    const {'1': 'voting_params', '3': 1, '4': 1, '5': 11, '6': '.cosmos.gov.v1.VotingParams', '10': 'votingParams'},
    const {'1': 'deposit_params', '3': 2, '4': 1, '5': 11, '6': '.cosmos.gov.v1.DepositParams', '10': 'depositParams'},
    const {'1': 'tally_params', '3': 3, '4': 1, '5': 11, '6': '.cosmos.gov.v1.TallyParams', '10': 'tallyParams'},
  ],
};

/// Descriptor for `QueryParamsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryParamsResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List queryDepositRequestDescriptor = $convert.base64Decode('ChNRdWVyeURlcG9zaXRSZXF1ZXN0Eh8KC3Byb3Bvc2FsX2lkGAEgASgEUgpwcm9wb3NhbElkEjYKCWRlcG9zaXRvchgCIAEoCUIY0rQtFGNvc21vcy5BZGRyZXNzU3RyaW5nUglkZXBvc2l0b3I=');
@$core.Deprecated('Use queryDepositResponseDescriptor instead')
const QueryDepositResponse$json = const {
  '1': 'QueryDepositResponse',
  '2': const [
    const {'1': 'deposit', '3': 1, '4': 1, '5': 11, '6': '.cosmos.gov.v1.Deposit', '10': 'deposit'},
  ],
};

/// Descriptor for `QueryDepositResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryDepositResponseDescriptor = $convert.base64Decode('ChRRdWVyeURlcG9zaXRSZXNwb25zZRIwCgdkZXBvc2l0GAEgASgLMhYuY29zbW9zLmdvdi52MS5EZXBvc2l0UgdkZXBvc2l0');
...
const QueryDepositsResponse$json = const {
  ...
  '2': const [
    const {'1': 'deposits', '3': 1, '4': 3, '5': 11, '6': '.cosmos.gov.v1.Deposit', '10': 'deposits'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryDepositsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryDepositsResponseDescriptor = $convert.base64Decode('ChVRdWVyeURlcG9zaXRzUmVzcG9uc2USMgoIZGVwb3NpdHMYASADKAsyFi5jb3Ntb3MuZ292LnYxLkRlcG9zaXRSCGRlcG9zaXRzEkcKCnBhZ2luYXRpb24YAiABKAsyJy5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXNwb25zZVIKcGFnaW5hdGlvbg==');
...
const QueryTallyResultResponse$json = const {
  ...
  '2': const [
    const {'1': 'tally', '3': 1, '4': 1, '5': 11, '6': '.cosmos.gov.v1.TallyResult', '10': 'tally'},
  ],
};

/// Descriptor for `QueryTallyResultResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryTallyResultResponseDescriptor = $convert.base64Decode('ChhRdWVyeVRhbGx5UmVzdWx0UmVzcG9uc2USMAoFdGFsbHkYASABKAsyGi5jb3Ntb3MuZ292LnYxLlRhbGx5UmVzdWx0UgV0YWxseQ==');
