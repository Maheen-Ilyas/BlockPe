...
class ProposalStatus extends $pb.ProtobufEnum {
  ...
  static const ProposalStatus PROPOSAL_STATUS_SUBMITTED = ProposalStatus._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PROPOSAL_STATUS_SUBMITTED');
  static const ProposalStatus PROPOSAL_STATUS_ACCEPTED = ProposalStatus._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PROPOSAL_STATUS_ACCEPTED');
  static const ProposalStatus PROPOSAL_STATUS_REJECTED = ProposalStatus._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PROPOSAL_STATUS_REJECTED');
  static const ProposalStatus PROPOSAL_STATUS_ABORTED = ProposalStatus._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PROPOSAL_STATUS_ABORTED');
  static const ProposalStatus PROPOSAL_STATUS_WITHDRAWN = ProposalStatus._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PROPOSAL_STATUS_WITHDRAWN');
...
class ProposalExecutorResult extends $pb.ProtobufEnum {
  static const ProposalExecutorResult PROPOSAL_EXECUTOR_RESULT_UNSPECIFIED = ProposalExecutorResult._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PROPOSAL_EXECUTOR_RESULT_UNSPECIFIED');
  static const ProposalExecutorResult PROPOSAL_EXECUTOR_RESULT_NOT_RUN = ProposalExecutorResult._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PROPOSAL_EXECUTOR_RESULT_NOT_RUN');
  static const ProposalExecutorResult PROPOSAL_EXECUTOR_RESULT_SUCCESS = ProposalExecutorResult._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PROPOSAL_EXECUTOR_RESULT_SUCCESS');
  static const ProposalExecutorResult PROPOSAL_EXECUTOR_RESULT_FAILURE = ProposalExecutorResult._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PROPOSAL_EXECUTOR_RESULT_FAILURE');
