...
final $typed_data.Uint8List eventCreateGroupDescriptor = $convert.base64Decode('ChBFdmVudENyZWF0ZUdyb3VwEhkKCGdyb3VwX2lkGAEgASgEUgdncm91cElk');
...
final $typed_data.Uint8List eventUpdateGroupDescriptor = $convert.base64Decode('ChBFdmVudFVwZGF0ZUdyb3VwEhkKCGdyb3VwX2lkGAEgASgEUgdncm91cElk');
...
final $typed_data.Uint8List eventCreateGroupPolicyDescriptor = $convert.base64Decode('ChZFdmVudENyZWF0ZUdyb3VwUG9saWN5EjIKB2FkZHJlc3MYASABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1IHYWRkcmVzcw==');
...
final $typed_data.Uint8List eventUpdateGroupPolicyDescriptor = $convert.base64Decode('ChZFdmVudFVwZGF0ZUdyb3VwUG9saWN5EjIKB2FkZHJlc3MYASABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1IHYWRkcmVzcw==');
...
final $typed_data.Uint8List eventSubmitProposalDescriptor = $convert.base64Decode('ChNFdmVudFN1Ym1pdFByb3Bvc2FsEh8KC3Byb3Bvc2FsX2lkGAEgASgEUgpwcm9wb3NhbElk');
...
final $typed_data.Uint8List eventWithdrawProposalDescriptor = $convert.base64Decode('ChVFdmVudFdpdGhkcmF3UHJvcG9zYWwSHwoLcHJvcG9zYWxfaWQYASABKARSCnByb3Bvc2FsSWQ=');
...
final $typed_data.Uint8List eventVoteDescriptor = $convert.base64Decode('CglFdmVudFZvdGUSHwoLcHJvcG9zYWxfaWQYASABKARSCnByb3Bvc2FsSWQ=');
...
final $typed_data.Uint8List eventExecDescriptor = $convert.base64Decode('CglFdmVudEV4ZWMSHwoLcHJvcG9zYWxfaWQYASABKARSCnByb3Bvc2FsSWQSPwoGcmVzdWx0GAIgASgOMicuY29zbW9zLmdyb3VwLnYxLlByb3Bvc2FsRXhlY3V0b3JSZXN1bHRSBnJlc3VsdBISCgRsb2dzGAMgASgJUgRsb2dz');
...
final $typed_data.Uint8List eventLeaveGroupDescriptor = $convert.base64Decode('Cg9FdmVudExlYXZlR3JvdXASGQoIZ3JvdXBfaWQYASABKARSB2dyb3VwSWQSMgoHYWRkcmVzcxgCIAEoCUIY0rQtFGNvc21vcy5BZGRyZXNzU3RyaW5nUgdhZGRyZXNz');
