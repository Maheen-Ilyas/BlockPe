...
class BaseVestingAccount extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BaseVestingAccount', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.vesting.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$3.Coin>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalVesting', $pb.PbFieldType.PM, subBuilder: $3.Coin.create)
    ..pc<$3.Coin>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'delegatedFree', $pb.PbFieldType.PM, subBuilder: $3.Coin.create)
    ..pc<$3.Coin>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'delegatedVesting', $pb.PbFieldType.PM, subBuilder: $3.Coin.create)
  ...
  factory BaseVestingAccount({
    ...
    $core.Iterable<$3.Coin>? originalVesting,
    $core.Iterable<$3.Coin>? delegatedFree,
    $core.Iterable<$3.Coin>? delegatedVesting,
  ...
  @$pb.TagNumber(2)
  $core.List<$3.Coin> get originalVesting => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<$3.Coin> get delegatedFree => $_getList(2);

  @$pb.TagNumber(4)
  $core.List<$3.Coin> get delegatedVesting => $_getList(3);
...
class Period extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Period', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.vesting.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$3.Coin>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amount', $pb.PbFieldType.PM, subBuilder: $3.Coin.create)
    ..hasRequiredFields = false
  ;
