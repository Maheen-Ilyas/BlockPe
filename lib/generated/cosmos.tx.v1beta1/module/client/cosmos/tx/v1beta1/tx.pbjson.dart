...
const SignDocDirectAux$json = const {
  ...
  '2': const [
    const {'1': 'body_bytes', '3': 1, '4': 1, '5': 12, '10': 'bodyBytes'},
    const {'1': 'public_key', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.Any', '10': 'publicKey'},
    const {'1': 'chain_id', '3': 3, '4': 1, '5': 9, '10': 'chainId'},
    const {'1': 'account_number', '3': 4, '4': 1, '5': 4, '10': 'accountNumber'},
    const {'1': 'sequence', '3': 5, '4': 1, '5': 4, '10': 'sequence'},
    const {'1': 'tip', '3': 6, '4': 1, '5': 11, '6': '.cosmos.tx.v1beta1.Tip', '10': 'tip'},
  ],
};

/// Descriptor for `SignDocDirectAux`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List signDocDirectAuxDescriptor = $convert.base64Decode('');
...
const AuthInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'tip', '3': 3, '4': 1, '5': 11, '6': '.cosmos.tx.v1beta1.Tip', '10': 'tip'},
  ],
};

/// Descriptor for `AuthInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List authInfoDescriptor = $convert.base64Decode('CghBdXRoSW5mbxJACgxzaWduZXJfaW5mb3MYASADKAsyHS5jb3Ntb3MudHgudjFiZXRhMS5TaWduZXJJbmZvUgtzaWduZXJJbmZvcxIoCgNmZWUYAiABKAsyFi5jb3Ntb3MudHgudjFiZXRhMS5GZWVSA2ZlZRIoCgN0aXAYAyABKAsyFi5jb3Ntb3MudHgudjFiZXRhMS5UaXBSA3RpcA==');
...
const Fee$json = const {
  ...
  '2': const [
    ...
    const {'1': 'granter', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'granter'},
  ],
};

/// Descriptor for `Fee`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List feeDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use tipDescriptor instead')
const Tip$json = const {
  '1': 'Tip',
  '2': const [
    const {'1': 'amount', '3': 1, '4': 3, '5': 11, '6': '.cosmos.base.v1beta1.Coin', '8': const {}, '10': 'amount'},
    const {'1': 'tipper', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'tipper'},
  ],
};

/// Descriptor for `Tip`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tipDescriptor = $convert.base64Decode('CgNUaXASYwoGYW1vdW50GAEgAygLMhkuY29zbW9zLmJhc2UudjFiZXRhMS5Db2luQjDI3h8Aqt8fKGdpdGh1Yi5jb20vY29zbW9zL2Nvc21vcy1zZGsvdHlwZXMuQ29pbnNSBmFtb3VudBIwCgZ0aXBwZXIYAiABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1IGdGlwcGVy');
...
const AuxSignerData$json = const {
  ...
  '2': const [
    ...
    const {'1': 'sign_doc', '3': 2, '4': 1, '5': 11, '6': '.cosmos.tx.v1beta1.SignDocDirectAux', '10': 'signDoc'},
    const {'1': 'mode', '3': 3, '4': 1, '5': 14, '6': '.cosmos.tx.signing.v1beta1.SignMode', '10': 'mode'},
    const {'1': 'sig', '3': 4, '4': 1, '5': 12, '10': 'sig'},
  ],
};

/// Descriptor for `AuxSignerData`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List auxSignerDataDescriptor = $convert.base64Decode('');
