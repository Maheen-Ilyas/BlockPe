...
import '../../base/query/v1beta1/pagination.pb.dart' as $16;
import 'tx.pb.dart' as $17;
import '../../base/abci/v1beta1/abci.pb.dart' as $18;
import '../../../tendermint/types/types.pb.dart' as $9;
import '../../../tendermint/types/block.pb.dart' as $19;
...
class GetTxsEventRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetTxsEventRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$16.PageRequest>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagination', subBuilder: $16.PageRequest.create)
    ...
    ..a<$fixnum.Int64>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'page', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  $16.PageRequest get pagination => $_getN(1);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  set pagination($16.PageRequest v) { setField(2, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  $16.PageRequest ensurePagination() => $_ensure(1);
...
class GetTxsEventResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetTxsEventResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..pc<$17.Tx>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'txs', $pb.PbFieldType.PM, subBuilder: $17.Tx.create)
    ..pc<$18.TxResponse>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'txResponses', $pb.PbFieldType.PM, subBuilder: $18.TxResponse.create)
    ..aOM<$16.PageResponse>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagination', subBuilder: $16.PageResponse.create)
    ..a<$fixnum.Int64>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'total', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;

  GetTxsEventResponse._() : super();
  factory GetTxsEventResponse({
    $core.Iterable<$17.Tx>? txs,
    $core.Iterable<$18.TxResponse>? txResponses,
  @$core.Deprecated('This field is deprecated.')
    $16.PageResponse? pagination,
    $fixnum.Int64? total,
  }) {
    final result = create();
    if (txs != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<$17.Tx> get txs => $_getList(0);

  @$pb.TagNumber(2)
  $core.List<$18.TxResponse> get txResponses => $_getList(1);

  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  $16.PageResponse get pagination => $_getN(2);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  set pagination($16.PageResponse v) { setField(3, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  $16.PageResponse ensurePagination() => $_ensure(2);
...
class BroadcastTxResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BroadcastTxResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..aOM<$18.TxResponse>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'txResponse', subBuilder: $18.TxResponse.create)
    ..hasRequiredFields = false
  ;

  BroadcastTxResponse._() : super();
  factory BroadcastTxResponse({
    $18.TxResponse? txResponse,
  }) {
    final result = create();
    if (txResponse != null) {
  ...
  @$pb.TagNumber(1)
  $18.TxResponse get txResponse => $_getN(0);
  @$pb.TagNumber(1)
  set txResponse($18.TxResponse v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTxResponse() => $_has(0);
  @$pb.TagNumber(1)
  void clearTxResponse() => clearField(1);
  @$pb.TagNumber(1)
  $18.TxResponse ensureTxResponse() => $_ensure(0);
}
...
class SimulateRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SimulateRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..aOM<$17.Tx>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tx', subBuilder: $17.Tx.create)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  $17.Tx get tx => $_getN(0);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  set tx($17.Tx v) { setField(1, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
...
class SimulateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SimulateResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..aOM<$18.GasInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gasInfo', subBuilder: $18.GasInfo.create)
    ..aOM<$18.Result>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'result', subBuilder: $18.Result.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $18.GasInfo get gasInfo => $_getN(0);
  @$pb.TagNumber(1)
  set gasInfo($18.GasInfo v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasGasInfo() => $_has(0);
  @$pb.TagNumber(1)
  void clearGasInfo() => clearField(1);
  @$pb.TagNumber(1)
  $18.GasInfo ensureGasInfo() => $_ensure(0);

  @$pb.TagNumber(2)
  $18.Result get result => $_getN(1);
  @$pb.TagNumber(2)
  set result($18.Result v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasResult() => $_has(1);
  @$pb.TagNumber(2)
  void clearResult() => clearField(2);
  @$pb.TagNumber(2)
  $18.Result ensureResult() => $_ensure(1);
}
...
class GetTxResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetTxResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..aOM<$17.Tx>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tx', subBuilder: $17.Tx.create)
    ..aOM<$18.TxResponse>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'txResponse', subBuilder: $18.TxResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $18.TxResponse get txResponse => $_getN(1);
  @$pb.TagNumber(2)
  set txResponse($18.TxResponse v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTxResponse() => $_has(1);
  @$pb.TagNumber(2)
  void clearTxResponse() => clearField(2);
  @$pb.TagNumber(2)
  $18.TxResponse ensureTxResponse() => $_ensure(1);
}
...
class GetBlockWithTxsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetBlockWithTxsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$19.Block>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'block', subBuilder: $19.Block.create)
    ..aOM<$16.PageResponse>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagination', subBuilder: $16.PageResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $19.Block get block => $_getN(2);
  @$pb.TagNumber(3)
  set block($19.Block v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBlock() => $_has(2);
  @$pb.TagNumber(3)
  void clearBlock() => clearField(3);
  @$pb.TagNumber(3)
  $19.Block ensureBlock() => $_ensure(2);

  @$pb.TagNumber(4)
  $16.PageResponse get pagination => $_getN(3);
  @$pb.TagNumber(4)
  set pagination($16.PageResponse v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasPagination() => $_has(3);
  @$pb.TagNumber(4)
  void clearPagination() => clearField(4);
  @$pb.TagNumber(4)
  $16.PageResponse ensurePagination() => $_ensure(3);
}
