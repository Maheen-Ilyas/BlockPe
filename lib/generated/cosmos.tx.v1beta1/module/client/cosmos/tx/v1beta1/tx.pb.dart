...
//
// @dart = 2.12
// ignore_for_file: annotate_overrides,camel_case_types,unnecessary_const,non_constant_identifier_names,library_prefixes,unused_import,unused_shown_name,return_of_invalid_type,unnecessary_this,prefer_final_fields, no_leading_underscores_for_local_identifiers, constant_identifier_names
...
import '../../crypto/multisig/v1beta1/multisig.pb.dart' as $12;
import '../../base/v1beta1/coin.pb.dart' as $13;

import '../signing/v1beta1/signing.pbenum.dart' as $14;
...
class SignDocDirectAux extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SignDocDirectAux', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bodyBytes', $pb.PbFieldType.OY)
    ..aOM<$11.Any>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKey', subBuilder: $11.Any.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'chainId')
    ..a<$fixnum.Int64>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountNumber', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ...
    ..aOM<Tip>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tip', subBuilder: Tip.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SignDocDirectAux copyWith(void Function(SignDocDirectAux) updates) => super.copyWith((message) => updates(message as SignDocDirectAux)) as SignDocDirectAux; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $11.Any get publicKey => $_getN(1);
  @$pb.TagNumber(2)
  set publicKey($11.Any v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPublicKey() => $_has(1);
  @$pb.TagNumber(2)
  void clearPublicKey() => clearField(2);
  @$pb.TagNumber(2)
  $11.Any ensurePublicKey() => $_ensure(1);
...
class TxBody extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TxBody', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..pc<$11.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messages', $pb.PbFieldType.PM, subBuilder: $11.Any.create)
    ...
    ..pc<$11.Any>(1023, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'extensionOptions', $pb.PbFieldType.PM, subBuilder: $11.Any.create)
    ..pc<$11.Any>(2047, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nonCriticalExtensionOptions', $pb.PbFieldType.PM, subBuilder: $11.Any.create)
    ..hasRequiredFields = false
  ;

  TxBody._() : super();
  factory TxBody({
    $core.Iterable<$11.Any>? messages,
    $core.String? memo,
  ...
  @$pb.TagNumber(1)
  $core.List<$11.Any> get messages => $_getList(0);
  ...
  @$pb.TagNumber(1023)
  $core.List<$11.Any> get extensionOptions => $_getList(3);

  @$pb.TagNumber(2047)
  $core.List<$11.Any> get nonCriticalExtensionOptions => $_getList(4);
}
...
class AuthInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuthInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<Tip>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tip', subBuilder: Tip.create)
    ..hasRequiredFields = false
  ;
...
class SignerInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SignerInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..aOM<$11.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKey', subBuilder: $11.Any.create)
  ...
  @$pb.TagNumber(1)
  $11.Any get publicKey => $_getN(0);
  @$pb.TagNumber(1)
  set publicKey($11.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPublicKey() => $_has(0);
  @$pb.TagNumber(1)
  void clearPublicKey() => clearField(1);
  @$pb.TagNumber(1)
  $11.Any ensurePublicKey() => $_ensure(0);
...
class ModeInfo_Single extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModeInfo.Single', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..e<$14.SignMode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mode', $pb.PbFieldType.OE, defaultOrMaker: $14.SignMode.SIGN_MODE_UNSPECIFIED, valueOf: $14.SignMode.valueOf, enumValues: $14.SignMode.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $14.SignMode get mode => $_getN(0);
  @$pb.TagNumber(1)
  set mode($14.SignMode v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ModeInfo_Multi extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModeInfo.Multi', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..aOM<$12.CompactBitArray>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bitarray', subBuilder: $12.CompactBitArray.create)
  ...
  @$pb.TagNumber(1)
  $12.CompactBitArray get bitarray => $_getN(0);
  @$pb.TagNumber(1)
  set bitarray($12.CompactBitArray v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBitarray() => $_has(0);
  @$pb.TagNumber(1)
  void clearBitarray() => clearField(1);
  @$pb.TagNumber(1)
  $12.CompactBitArray ensureBitarray() => $_ensure(0);
...
class Fee extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Fee', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..pc<$13.Coin>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amount', $pb.PbFieldType.PM, subBuilder: $13.Coin.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$13.Coin> get amount => $_getList(0);
...
class Tip extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Tip', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..pc<$13.Coin>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amount', $pb.PbFieldType.PM, subBuilder: $13.Coin.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tipper')
    ..hasRequiredFields = false
  ;
...
class AuxSignerData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuxSignerData', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'address')
    ..aOM<SignDocDirectAux>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signDoc', subBuilder: SignDocDirectAux.create)
    ..e<$14.SignMode>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mode', $pb.PbFieldType.OE, defaultOrMaker: $14.SignMode.SIGN_MODE_UNSPECIFIED, valueOf: $14.SignMode.valueOf, enumValues: $14.SignMode.values)
    ..a<$core.List<$core.int>>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sig', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AuxSignerData copyWith(void Function(AuxSignerData) updates) => super.copyWith((message) => updates(message as AuxSignerData)) as AuxSignerData; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  $14.SignMode get mode => $_getN(2);
  @$pb.TagNumber(3)
  set mode($14.SignMode v) { setField(3, v); }
  @$pb.TagNumber(3)
