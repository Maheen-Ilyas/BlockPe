...
const ABCIMessageLog$json = const {
  '1': 'ABCIMessageLog',
  '2': const [
    const {'1': 'msg_index', '3': 1, '4': 1, '5': 13, '8': const {}, '10': 'msgIndex'},
...
final $typed_data.Uint8List aBCIMessageLogDescriptor = $convert.base64Decode('Cg5BQkNJTWVzc2FnZUxvZxIqCgltc2dfaW5kZXgYASABKA1CDereHwltc2dfaW5kZXhSCG1zZ0luZGV4EhAKA2xvZxgCIAEoCVIDbG9nElMKBmV2ZW50cxgDIAMoCzIlLmNvc21vcy5iYXNlLmFiY2kudjFiZXRhMS5TdHJpbmdFdmVudEIUqt8fDFN0cmluZ0V2ZW50c8jeHwBSBmV2ZW50czoEgNwgAQ==');
...
final $typed_data.Uint8List gasInfoDescriptor = $convert.base64Decode('CgdHYXNJbmZvEh0KCmdhc193YW50ZWQYASABKARSCWdhc1dhbnRlZBIZCghnYXNfdXNlZBgCIAEoBFIHZ2FzVXNlZA==');
...
const Result$json = const {
  ...
  '2': const [
    ...
    const {'1': 'msg_responses', '3': 4, '4': 3, '5': 11, '6': '.google.protobuf.Any', '10': 'msgResponses'},
  ],
  '7': const {},
};

/// Descriptor for `Result`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List resultDescriptor = $convert.base64Decode('CgZSZXN1bHQSFgoEZGF0YRgBIAEoDEICGAFSBGRhdGESEAoDbG9nGAIgASgJUgNsb2cSNAoGZXZlbnRzGAMgAygLMhYudGVuZGVybWludC5hYmNpLkV2ZW50QgTI3h8AUgZldmVudHMSOQoNbXNnX3Jlc3BvbnNlcxgEIAMoCzIULmdvb2dsZS5wcm90b2J1Zi5BbnlSDG1zZ1Jlc3BvbnNlczoEiKAfAA==');
...
final $typed_data.Uint8List msgDataDescriptor = $convert.base64Decode('CgdNc2dEYXRhEhkKCG1zZ190eXBlGAEgASgJUgdtc2dUeXBlEhIKBGRhdGEYAiABKAxSBGRhdGE6BhgBgNwgAQ==');
...
const TxMsgData$json = const {
  ...
  '2': const [
    ...
    const {'1': 'msg_responses', '3': 2, '4': 3, '5': 11, '6': '.google.protobuf.Any', '10': 'msgResponses'},
  ],
  '7': const {},
};

/// Descriptor for `TxMsgData`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List txMsgDataDescriptor = $convert.base64Decode('CglUeE1zZ0RhdGESOQoEZGF0YRgBIAMoCzIhLmNvc21vcy5iYXNlLmFiY2kudjFiZXRhMS5Nc2dEYXRhQgIYAVIEZGF0YRI5Cg1tc2dfcmVzcG9uc2VzGAIgAygLMhQuZ29vZ2xlLnByb3RvYnVmLkFueVIMbXNnUmVzcG9uc2VzOgSA3CAB');
...
final $typed_data.Uint8List searchTxsResultDescriptor = $convert.base64Decode('');
