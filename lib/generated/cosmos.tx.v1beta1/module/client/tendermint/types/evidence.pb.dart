...
class DuplicateVoteEvidence extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DuplicateVoteEvidence', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.types'), createEmptyInstance: create)
    ..aOM<$9.Vote>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'voteA', subBuilder: $9.Vote.create)
    ..aOM<$9.Vote>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'voteB', subBuilder: $9.Vote.create)
  ...
  @$pb.TagNumber(1)
  $9.Vote get voteA => $_getN(0);
  @$pb.TagNumber(1)
  set voteA($9.Vote v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasVoteA() => $_has(0);
  @$pb.TagNumber(1)
  void clearVoteA() => clearField(1);
  @$pb.TagNumber(1)
  $9.Vote ensureVoteA() => $_ensure(0);

  @$pb.TagNumber(2)
  $9.Vote get voteB => $_getN(1);
  @$pb.TagNumber(2)
  set voteB($9.Vote v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasVoteB() => $_has(1);
  @$pb.TagNumber(2)
  void clearVoteB() => clearField(2);
  @$pb.TagNumber(2)
  $9.Vote ensureVoteB() => $_ensure(1);
...
class LightClientAttackEvidence extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LightClientAttackEvidence', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.types'), createEmptyInstance: create)
    ..aOM<$9.LightBlock>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conflictingBlock', subBuilder: $9.LightBlock.create)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commonHeight')
    ..pc<$7.Validator>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'byzantineValidators', $pb.PbFieldType.PM, subBuilder: $7.Validator.create)
  ...
  factory LightClientAttackEvidence({
    $9.LightBlock? conflictingBlock,
    $fixnum.Int64? commonHeight,
    $core.Iterable<$7.Validator>? byzantineValidators,
    $fixnum.Int64? totalVotingPower,
    $6.Timestamp? timestamp,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $9.LightBlock get conflictingBlock => $_getN(0);
  @$pb.TagNumber(1)
  set conflictingBlock($9.LightBlock v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasConflictingBlock() => $_has(0);
  @$pb.TagNumber(1)
  void clearConflictingBlock() => clearField(1);
  @$pb.TagNumber(1)
  $9.LightBlock ensureConflictingBlock() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $core.List<$7.Validator> get byzantineValidators => $_getList(2);
