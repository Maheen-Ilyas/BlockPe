...
class Block extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Block', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.types'), createEmptyInstance: create)
    ..aOM<$9.Header>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'header', subBuilder: $9.Header.create)
    ..aOM<$9.Data>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'data', subBuilder: $9.Data.create)
    ..aOM<$15.EvidenceList>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'evidence', subBuilder: $15.EvidenceList.create)
    ..aOM<$9.Commit>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastCommit', subBuilder: $9.Commit.create)
  ...
  @$pb.TagNumber(1)
  $9.Header get header => $_getN(0);
  @$pb.TagNumber(1)
  set header($9.Header v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasHeader() => $_has(0);
  @$pb.TagNumber(1)
  void clearHeader() => clearField(1);
  @$pb.TagNumber(1)
  $9.Header ensureHeader() => $_ensure(0);

  @$pb.TagNumber(2)
  $9.Data get data => $_getN(1);
  @$pb.TagNumber(2)
  set data($9.Data v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasData() => $_has(1);
  @$pb.TagNumber(2)
  void clearData() => clearField(2);
  @$pb.TagNumber(2)
  $9.Data ensureData() => $_ensure(1);

  @$pb.TagNumber(3)
  $15.EvidenceList get evidence => $_getN(2);
  @$pb.TagNumber(3)
  set evidence($15.EvidenceList v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasEvidence() => $_has(2);
  @$pb.TagNumber(3)
  void clearEvidence() => clearField(3);
  @$pb.TagNumber(3)
  $15.EvidenceList ensureEvidence() => $_ensure(2);

  @$pb.TagNumber(4)
  $9.Commit get lastCommit => $_getN(3);
  @$pb.TagNumber(4)
  set lastCommit($9.Commit v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLastCommit() => $_has(3);
  @$pb.TagNumber(4)
  void clearLastCommit() => clearField(4);
  @$pb.TagNumber(4)
  $9.Commit ensureLastCommit() => $_ensure(3);
}
