...
final $typed_data.Uint8List queryConsensusStateHeightsRequestDescriptor = $convert.base64Decode('CiFRdWVyeUNvbnNlbnN1c1N0YXRlSGVpZ2h0c1JlcXVlc3QSGwoJY2xpZW50X2lkGAEgASgJUghjbGllbnRJZBJGCgpwYWdpbmF0aW9uGAIgASgLMiYuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVxdWVzdFIKcGFnaW5hdGlvbg==');
...
const QueryConsensusStateHeightsResponse$json = const {
  ...
  '2': const [
    const {'1': 'consensus_state_heights', '3': 1, '4': 3, '5': 11, '6': '.ibc.core.client.v1.Height', '8': const {}, '10': 'consensusStateHeights'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryConsensusStateHeightsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryConsensusStateHeightsResponseDescriptor = $convert.base64Decode('');
