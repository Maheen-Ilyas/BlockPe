...
class QueryClientStateRequest extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  QueryClientStateRequest copyWith(void Function(QueryClientStateRequest) updates) => super.copyWith((message) => updates(message as QueryClientStateRequest)) as QueryClientStateRequest; // ignore: deprecated_member_use
...
class QueryClientStateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryClientStateResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ...
    ..aOM<$5.Height>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight', subBuilder: $5.Height.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryClientStateResponse copyWith(void Function(QueryClientStateResponse) updates) => super.copyWith((message) => updates(message as QueryClientStateResponse)) as QueryClientStateResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set proofHeight($5.Height v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class QueryClientStatesRequest extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryClientStatesRequest copyWith(void Function(QueryClientStatesRequest) updates) => super.copyWith((message) => updates(message as QueryClientStatesRequest)) as QueryClientStatesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class QueryClientStatesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryClientStatesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..pc<$5.IdentifiedClientState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientStates', $pb.PbFieldType.PM, subBuilder: $5.IdentifiedClientState.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryClientStatesResponse copyWith(void Function(QueryClientStatesResponse) updates) => super.copyWith((message) => updates(message as QueryClientStatesResponse)) as QueryClientStatesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class QueryConsensusStateRequest extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryConsensusStateRequest copyWith(void Function(QueryConsensusStateRequest) updates) => super.copyWith((message) => updates(message as QueryConsensusStateRequest)) as QueryConsensusStateRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class QueryConsensusStateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryConsensusStateResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..aOM<$3.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusState', subBuilder: $3.Any.create)
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proof', $pb.PbFieldType.OY)
    ..aOM<$5.Height>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight', subBuilder: $5.Height.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryConsensusStateResponse copyWith(void Function(QueryConsensusStateResponse) updates) => super.copyWith((message) => updates(message as QueryConsensusStateResponse)) as QueryConsensusStateResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set consensusState($3.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class QueryConsensusStatesRequest extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryConsensusStatesRequest copyWith(void Function(QueryConsensusStatesRequest) updates) => super.copyWith((message) => updates(message as QueryConsensusStatesRequest)) as QueryConsensusStatesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class QueryConsensusStatesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryConsensusStatesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..pc<$5.ConsensusStateWithHeight>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusStates', $pb.PbFieldType.PM, subBuilder: $5.ConsensusStateWithHeight.create)
    ..aOM<$7.PageResponse>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagination', subBuilder: $7.PageResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryConsensusStatesResponse copyWith(void Function(QueryConsensusStatesResponse) updates) => super.copyWith((message) => updates(message as QueryConsensusStatesResponse)) as QueryConsensusStatesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class QueryConsensusStateHeightsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryConsensusStateHeightsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientId')
    ..aOM<$7.PageRequest>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagination', subBuilder: $7.PageRequest.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryConsensusStateHeightsRequest clone() => QueryConsensusStateHeightsRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryConsensusStateHeightsRequest copyWith(void Function(QueryConsensusStateHeightsRequest) updates) => super.copyWith((message) => updates(message as QueryConsensusStateHeightsRequest)) as QueryConsensusStateHeightsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryConsensusStateHeightsRequest create() => QueryConsensusStateHeightsRequest._();
  QueryConsensusStateHeightsRequest createEmptyInstance() => create();
  static $pb.PbList<QueryConsensusStateHeightsRequest> createRepeated() => $pb.PbList<QueryConsensusStateHeightsRequest>();
  @$core.pragma('dart2js:noInline')
  static QueryConsensusStateHeightsRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryConsensusStateHeightsRequest>(create);
...
class QueryConsensusStateHeightsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryConsensusStateHeightsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..pc<$5.Height>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusStateHeights', $pb.PbFieldType.PM, subBuilder: $5.Height.create)
    ..aOM<$7.PageResponse>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagination', subBuilder: $7.PageResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryConsensusStateHeightsResponse clone() => QueryConsensusStateHeightsResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryConsensusStateHeightsResponse copyWith(void Function(QueryConsensusStateHeightsResponse) updates) => super.copyWith((message) => updates(message as QueryConsensusStateHeightsResponse)) as QueryConsensusStateHeightsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryConsensusStateHeightsResponse create() => QueryConsensusStateHeightsResponse._();
  QueryConsensusStateHeightsResponse createEmptyInstance() => create();
  static $pb.PbList<QueryConsensusStateHeightsResponse> createRepeated() => $pb.PbList<QueryConsensusStateHeightsResponse>();
  @$core.pragma('dart2js:noInline')
  static QueryConsensusStateHeightsResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryConsensusStateHeightsResponse>(create);
  static QueryConsensusStateHeightsResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$5.Height> get consensusStateHeights => $_getList(0);
...
class QueryClientStatusRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryClientStatusRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryClientStatusRequest clone() => QueryClientStatusRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryClientStatusRequest copyWith(void Function(QueryClientStatusRequest) updates) => super.copyWith((message) => updates(message as QueryClientStatusRequest)) as QueryClientStatusRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryClientStatusRequest create() => QueryClientStatusRequest._();
  QueryClientStatusRequest createEmptyInstance() => create();
  static $pb.PbList<QueryClientStatusRequest> createRepeated() => $pb.PbList<QueryClientStatusRequest>();
  @$core.pragma('dart2js:noInline')
  static QueryClientStatusRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryClientStatusRequest>(create);
...
class QueryClientStatusResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryClientStatusResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryClientStatusResponse clone() => QueryClientStatusResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryClientStatusResponse copyWith(void Function(QueryClientStatusResponse) updates) => super.copyWith((message) => updates(message as QueryClientStatusResponse)) as QueryClientStatusResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryClientStatusResponse create() => QueryClientStatusResponse._();
  QueryClientStatusResponse createEmptyInstance() => create();
  static $pb.PbList<QueryClientStatusResponse> createRepeated() => $pb.PbList<QueryClientStatusResponse>();
  @$core.pragma('dart2js:noInline')
  static QueryClientStatusResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryClientStatusResponse>(create);
...
class QueryClientParamsRequest extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryClientParamsRequest copyWith(void Function(QueryClientParamsRequest) updates) => super.copyWith((message) => updates(message as QueryClientParamsRequest)) as QueryClientParamsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class QueryClientParamsResponse extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryClientParamsResponse copyWith(void Function(QueryClientParamsResponse) updates) => super.copyWith((message) => updates(message as QueryClientParamsResponse)) as QueryClientParamsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class QueryUpgradedClientStateRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryUpgradedClientStateRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;

  QueryUpgradedClientStateRequest._() : super();
  factory QueryUpgradedClientStateRequest() => create();
  factory QueryUpgradedClientStateRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory QueryUpgradedClientStateRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryUpgradedClientStateRequest clone() => QueryUpgradedClientStateRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryUpgradedClientStateRequest copyWith(void Function(QueryUpgradedClientStateRequest) updates) => super.copyWith((message) => updates(message as QueryUpgradedClientStateRequest)) as QueryUpgradedClientStateRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryUpgradedClientStateRequest create() => QueryUpgradedClientStateRequest._();
  QueryUpgradedClientStateRequest createEmptyInstance() => create();
  static $pb.PbList<QueryUpgradedClientStateRequest> createRepeated() => $pb.PbList<QueryUpgradedClientStateRequest>();
  @$core.pragma('dart2js:noInline')
  static QueryUpgradedClientStateRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryUpgradedClientStateRequest>(create);
...
class QueryUpgradedClientStateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryUpgradedClientStateResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..aOM<$3.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'upgradedClientState', subBuilder: $3.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryUpgradedClientStateResponse clone() => QueryUpgradedClientStateResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryUpgradedClientStateResponse copyWith(void Function(QueryUpgradedClientStateResponse) updates) => super.copyWith((message) => updates(message as QueryUpgradedClientStateResponse)) as QueryUpgradedClientStateResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryUpgradedClientStateResponse create() => QueryUpgradedClientStateResponse._();
  QueryUpgradedClientStateResponse createEmptyInstance() => create();
  static $pb.PbList<QueryUpgradedClientStateResponse> createRepeated() => $pb.PbList<QueryUpgradedClientStateResponse>();
  @$core.pragma('dart2js:noInline')
  static QueryUpgradedClientStateResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryUpgradedClientStateResponse>(create);
  static QueryUpgradedClientStateResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $3.Any get upgradedClientState => $_getN(0);
  @$pb.TagNumber(1)
  set upgradedClientState($3.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class QueryUpgradedConsensusStateRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryUpgradedConsensusStateRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class QueryUpgradedConsensusStateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryUpgradedConsensusStateResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..aOM<$3.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'upgradedConsensusState', subBuilder: $3.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set upgradedConsensusState($3.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
