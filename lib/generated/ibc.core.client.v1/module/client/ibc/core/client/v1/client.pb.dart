...
import '../../../../cosmos/upgrade/v1beta1/upgrade.pb.dart' as $4;
...
class IdentifiedClientState extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $3.Any ensureClientState() => $_ensure(1);
}
...
class ConsensusStateWithHeight extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $3.Any ensureConsensusState() => $_ensure(1);
}
...
class UpgradeProposal extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpgradeProposal', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'title')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOM<$4.Plan>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'plan', subBuilder: $4.Plan.create)
    ..aOM<$3.Any>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'upgradedClientState', subBuilder: $3.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4.Plan get plan => $_getN(2);
  @$pb.TagNumber(3)
  set plan($4.Plan v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPlan() => $_has(2);
  @$pb.TagNumber(3)
  void clearPlan() => clearField(3);
  @$pb.TagNumber(3)
  $4.Plan ensurePlan() => $_ensure(2);

  @$pb.TagNumber(4)
  $3.Any get upgradedClientState => $_getN(3);
  @$pb.TagNumber(4)
  set upgradedClientState($3.Any v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUpgradedClientState() => $_has(3);
  @$pb.TagNumber(4)
  void clearUpgradedClientState() => clearField(4);
  @$pb.TagNumber(4)
  $3.Any ensureUpgradedClientState() => $_ensure(3);
}
