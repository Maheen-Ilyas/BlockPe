...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..pc<$5.IdentifiedClientState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clients', $pb.PbFieldType.PM, subBuilder: $5.IdentifiedClientState.create)
    ..pc<$5.ClientConsensusStates>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientsConsensus', $pb.PbFieldType.PM, subBuilder: $5.ClientConsensusStates.create)
    ...
    ..aOM<$5.Params>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params', subBuilder: $5.Params.create)
  ...
  @$pb.TagNumber(4)
  set params($5.Params v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class GenesisMetadata extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenesisMetadata copyWith(void Function(GenesisMetadata) updates) => super.copyWith((message) => updates(message as GenesisMetadata)) as GenesisMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IdentifiedGenesisMetadata extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IdentifiedGenesisMetadata copyWith(void Function(IdentifiedGenesisMetadata) updates) => super.copyWith((message) => updates(message as IdentifiedGenesisMetadata)) as IdentifiedGenesisMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
