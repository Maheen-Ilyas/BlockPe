...
const Params$json = const {
  '1': 'Params',
  '2': const [
    const {'1': 'controller_enabled', '3': 1, '4': 1, '5': 8, '8': const {}, '10': 'controllerEnabled'},
  ],
};

/// Descriptor for `Params`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List paramsDescriptor = $convert.base64Decode('CgZQYXJhbXMSTAoSY29udHJvbGxlcl9lbmFibGVkGAEgASgIQh3y3h8ZeWFtbDoiY29udHJvbGxlcl9lbmFibGVkIlIRY29udHJvbGxlckVuYWJsZWQ=');
