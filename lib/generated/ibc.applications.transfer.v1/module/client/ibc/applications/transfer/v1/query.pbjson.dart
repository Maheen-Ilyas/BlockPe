...
final $typed_data.Uint8List queryEscrowAddressRequestDescriptor = $convert.base64Decode('ChlRdWVyeUVzY3Jvd0FkZHJlc3NSZXF1ZXN0EhcKB3BvcnRfaWQYASABKAlSBnBvcnRJZBIdCgpjaGFubmVsX2lkGAIgASgJUgljaGFubmVsSWQ=');
...
const QueryEscrowAddressResponse$json = const {
  ...
  '2': const [
    const {'1': 'escrow_address', '3': 1, '4': 1, '5': 9, '10': 'escrowAddress'},
  ],
};

/// Descriptor for `QueryEscrowAddressResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryEscrowAddressResponseDescriptor = $convert.base64Decode('ChpRdWVyeUVzY3Jvd0FkZHJlc3NSZXNwb25zZRIlCg5lc2Nyb3dfYWRkcmVzcxgBIAEoCVINZXNjcm93QWRkcmVzcw==');
