...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.channel.v1'), createEmptyInstance: create)
    ...
    ..pc<$6.PacketState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'acknowledgements', $pb.PbFieldType.PM, subBuilder: $6.PacketState.create)
    ..pc<$6.PacketState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commitments', $pb.PbFieldType.PM, subBuilder: $6.PacketState.create)
    ..pc<$6.PacketState>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'receipts', $pb.PbFieldType.PM, subBuilder: $6.PacketState.create)
  ...
  factory GenesisState({
    ...
    $core.Iterable<$6.PacketState>? receipts,
  ...
  @$pb.TagNumber(2)
  $core.List<$6.PacketState> get acknowledgements => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<$6.PacketState> get commitments => $_getList(2);

  @$pb.TagNumber(4)
  $core.List<$6.PacketState> get receipts => $_getList(3);
...
class PacketSequence extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PacketSequence copyWith(void Function(PacketSequence) updates) => super.copyWith((message) => updates(message as PacketSequence)) as PacketSequence; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
