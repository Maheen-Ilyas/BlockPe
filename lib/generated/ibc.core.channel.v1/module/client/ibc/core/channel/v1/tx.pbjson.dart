...
final $typed_data.Uint8List responseResultTypeDescriptor = $convert.base64Decode('ChJSZXNwb25zZVJlc3VsdFR5cGUSNQogUkVTUE9OU0VfUkVTVUxUX1RZUEVfVU5TUEVDSUZJRUQQABoPip0gC1VOU1BFQ0lGSUVEEicKGVJFU1BPTlNFX1JFU1VMVF9UWVBFX05PT1AQARoIip0gBE5PT1ASLQocUkVTUE9OU0VfUkVTVUxUX1RZUEVfU1VDQ0VTUxACGguKnSAHU1VDQ0VTUxoEiKMeAA==');
...
final $typed_data.Uint8List msgChannelOpenInitDescriptor = $convert.base64Decode('ChJNc2dDaGFubmVsT3BlbkluaXQSKwoHcG9ydF9pZBgBIAEoCUIS8t4fDnlhbWw6InBvcnRfaWQiUgZwb3J0SWQSPAoHY2hhbm5lbBgCIAEoCzIcLmliYy5jb3JlLmNoYW5uZWwudjEuQ2hhbm5lbEIEyN4fAFIHY2hhbm5lbBIWCgZzaWduZXIYAyABKAlSBnNpZ25lcjoI6KAfAIigHwA=');
...
const MsgChannelOpenInitResponse$json = const {
  ...
  '2': const [
    const {'1': 'channel_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'channelId'},
    const {'1': 'version', '3': 2, '4': 1, '5': 9, '10': 'version'},
  ],
};

/// Descriptor for `MsgChannelOpenInitResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List msgChannelOpenInitResponseDescriptor = $convert.base64Decode('ChpNc2dDaGFubmVsT3BlbkluaXRSZXNwb25zZRI0CgpjaGFubmVsX2lkGAEgASgJQhXy3h8ReWFtbDoiY2hhbm5lbF9pZCJSCWNoYW5uZWxJZBIYCgd2ZXJzaW9uGAIgASgJUgd2ZXJzaW9u');
...
final $typed_data.Uint8List msgChannelOpenTryDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgChannelOpenTryResponseDescriptor = $convert.base64Decode('ChlNc2dDaGFubmVsT3BlblRyeVJlc3BvbnNlEhgKB3ZlcnNpb24YASABKAlSB3ZlcnNpb24=');
...
final $typed_data.Uint8List msgChannelOpenAckDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgChannelOpenAckResponseDescriptor = $convert.base64Decode('ChlNc2dDaGFubmVsT3BlbkFja1Jlc3BvbnNl');
...
final $typed_data.Uint8List msgChannelOpenConfirmDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgChannelOpenConfirmResponseDescriptor = $convert.base64Decode('Ch1Nc2dDaGFubmVsT3BlbkNvbmZpcm1SZXNwb25zZQ==');
...
final $typed_data.Uint8List msgChannelCloseInitDescriptor = $convert.base64Decode('ChNNc2dDaGFubmVsQ2xvc2VJbml0EisKB3BvcnRfaWQYASABKAlCEvLeHw55YW1sOiJwb3J0X2lkIlIGcG9ydElkEjQKCmNoYW5uZWxfaWQYAiABKAlCFfLeHxF5YW1sOiJjaGFubmVsX2lkIlIJY2hhbm5lbElkEhYKBnNpZ25lchgDIAEoCVIGc2lnbmVyOgjooB8AiKAfAA==');
...
final $typed_data.Uint8List msgChannelCloseInitResponseDescriptor = $convert.base64Decode('ChtNc2dDaGFubmVsQ2xvc2VJbml0UmVzcG9uc2U=');
...
final $typed_data.Uint8List msgChannelCloseConfirmDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgChannelCloseConfirmResponseDescriptor = $convert.base64Decode('Ch5Nc2dDaGFubmVsQ2xvc2VDb25maXJtUmVzcG9uc2U=');
...
final $typed_data.Uint8List msgRecvPacketDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use msgRecvPacketResponseDescriptor instead')
const MsgRecvPacketResponse$json = const {
  '1': 'MsgRecvPacketResponse',
  '2': const [
    const {'1': 'result', '3': 1, '4': 1, '5': 14, '6': '.ibc.core.channel.v1.ResponseResultType', '10': 'result'},
  ],
  '7': const {},
};

/// Descriptor for `MsgRecvPacketResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List msgRecvPacketResponseDescriptor = $convert.base64Decode('ChVNc2dSZWN2UGFja2V0UmVzcG9uc2USPwoGcmVzdWx0GAEgASgOMicuaWJjLmNvcmUuY2hhbm5lbC52MS5SZXNwb25zZVJlc3VsdFR5cGVSBnJlc3VsdDoEiKAfAA==');
...
final $typed_data.Uint8List msgTimeoutDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgTimeoutResponseDescriptor = $convert.base64Decode('ChJNc2dUaW1lb3V0UmVzcG9uc2USPwoGcmVzdWx0GAEgASgOMicuaWJjLmNvcmUuY2hhbm5lbC52MS5SZXNwb25zZVJlc3VsdFR5cGVSBnJlc3VsdDoEiKAfAA==');
...
final $typed_data.Uint8List msgTimeoutOnCloseResponseDescriptor = $convert.base64Decode('ChlNc2dUaW1lb3V0T25DbG9zZVJlc3BvbnNlEj8KBnJlc3VsdBgBIAEoDjInLmliYy5jb3JlLmNoYW5uZWwudjEuUmVzcG9uc2VSZXN1bHRUeXBlUgZyZXN1bHQ6BIigHwA=');
...
final $typed_data.Uint8List msgAcknowledgementDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgAcknowledgementResponseDescriptor = $convert.base64Decode('ChpNc2dBY2tub3dsZWRnZW1lbnRSZXNwb25zZRI/CgZyZXN1bHQYASABKA4yJy5pYmMuY29yZS5jaGFubmVsLnYxLlJlc3BvbnNlUmVzdWx0VHlwZVIGcmVzdWx0OgSIoB8A');
