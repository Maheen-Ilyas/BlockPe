...
//
// @dart = 2.12
// ignore_for_file: annotate_overrides,camel_case_types,unnecessary_const,non_constant_identifier_names,library_prefixes,unused_import,unused_shown_name,return_of_invalid_type,unnecessary_this,prefer_final_fields, constant_identifier_names, no_leading_underscores_for_local_identifiers
...
class IdentifiedChannel extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IdentifiedChannel copyWith(void Function(IdentifiedChannel) updates) => super.copyWith((message) => updates(message as IdentifiedChannel)) as IdentifiedChannel; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Counterparty extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Counterparty copyWith(void Function(Counterparty) updates) => super.copyWith((message) => updates(message as Counterparty)) as Counterparty; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Packet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Packet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.channel.v1'), createEmptyInstance: create)
    ...
    ..aOM<$5.Height>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeoutHeight', subBuilder: $5.Height.create)
  ...
  @$pb.TagNumber(7)
  $5.Height get timeoutHeight => $_getN(6);
  @$pb.TagNumber(7)
  set timeoutHeight($5.Height v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasTimeoutHeight() => $_has(6);
  @$pb.TagNumber(7)
  void clearTimeoutHeight() => clearField(7);
  @$pb.TagNumber(7)
  $5.Height ensureTimeoutHeight() => $_ensure(6);
...
class PacketState extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PacketState copyWith(void Function(PacketState) updates) => super.copyWith((message) => updates(message as PacketState)) as PacketState; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PacketId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PacketId', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.channel.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'portId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'channelId')
    ..a<$fixnum.Int64>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sequence', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PacketId copyWith(void Function(PacketId) updates) => super.copyWith((message) => updates(message as PacketId)) as PacketId; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static PacketId getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PacketId>(create);
